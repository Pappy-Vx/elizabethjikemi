        ...
        <div className="w-full mx-auto">
          <div className="w-full ">
            <span className="flex flex-col md:flex-row items-center">
              <span><img src="/orgclimate.png" alt="family-stakeholder" className="w-20" /></span>
            ...
            <p className="text-md md:text-lg font-sourceSerif mb-4">
              Just as the weather influences how crops grow, the culture within an organization influences how people thrive. You cannot build anything meaningful in a toxic atmosphere, which is why I pay close attention to the undercurrent—the quiet interactions, the pauses in meetings, and the way junior staff are treated when no one is watching.
            </p>
            <br />
            <p className="text-md md:text-lg font-sourceSerif mb-4">
